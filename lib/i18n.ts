...
const translations: Record<Language, Record<string, string>> = {
  en: {
    ...
    "constituency.findSubtitle": "Select your area to find your constituency and see who's standing",
    ...
    "constituency.candidateList": "Candidate List",
    "constituency.winner2024": "✓ Winner 2024",
    "constituency.criminalCases": "Criminal Cases",
    "constituency.totalAssets": "Assets",
    "constituency.education": "Education",
    "constituency.nota": "None of the Above (NOTA)",
    "constituency.notaSubtext": "Your right to reject all candidates",
    "constituency.noDataDistrict": "Candidate data for this district isn't in our 2024 dataset yet",
    "constituency.viewOnMyneta": "View on MyNeta →",
    "constituency.dataSource": "Data sourced from ADR/MyNeta · 2024 Lok Sabha · Official Affidavits",
    "constituency.viewFullDetails": "View Full Details on MyNeta ↗",
    "constituency.dataDisclaimer": "Data based on ADR/MyNeta 2024 Lok Sabha analysis reports. Figures are approximate. Verify exact details at myneta.info",
  },
  ...
  hi: {
    ...
    // Find Constituency
    "constituency.findConstituency": "अपना निर्वाचन क्षेत्र और उम्मीदवार खोजें",
    "constituency.findSubtitle": "अपना क्षेत्र चुनें और देखें कि कौन खड़ा है",
    ...
    "constituency.candidateList": "उम्मीदवार सूची",
    "constituency.winner2024": "✓ विजेता 2024",
    "constituency.criminalCases": "आपराधिक मामले",
    "constituency.totalAssets": "संपत्ति",
    "constituency.education": "शिक्षा",
    "constituency.nota": "उपरोक्त में से कोई नहीं (NOTA)",
    "constituency.notaSubtext": "सभी उम्मीदवारों को अस्वीकार करने का आपका अधिकार",
    "constituency.noDataDistrict": "इस जिले का डेटा हमारे 2024 डेटासेट में उपलब्ध नहीं है",
    "constituency.viewOnMyneta": "MyNeta पर देखें →",
    "constituency.dataSource": "डेटा स्रोत: ADR/MyNeta · 2024 लोक सभा · आधिकारिक शपथ पत्र",
    "constituency.viewFullDetails": "MyNeta पर पूरी जानकारी देखें ↗",
    "constituency.dataDisclaimer": "डेटा ADR/MyNeta 2024 लोक सभा विश्लेषण रिपोर्ट पर आधारित है। आंकड़े अनुमानित हैं। सटीक विवरण myneta.info पर सत्यापित करें",
  },
};
